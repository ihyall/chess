...
pawn_b = pg.image.load(os.path.join(img_folder, 'pawn_black.png'))
rook_w = pg.image.load(os.path.join(img_folder, 'rook_white.png'))
rook_b = pg.image.load(os.path.join(img_folder, 'rook_black.png'))
knight_w = pg.image.load(os.path.join(img_folder, 'knight_white.png'))
knight_b = pg.image.load(os.path.join(img_folder, 'knight_black.png'))
bishop_w = pg.image.load(os.path.join(img_folder, 'bishop_white.png'))
bishop_b = pg.image.load(os.path.join(img_folder, 'bishop_black.png'))
queen_w = pg.image.load(os.path.join(img_folder, 'queen_white.png'))
queen_b = pg.image.load(os.path.join(img_folder, 'queen_black.png'))
king_w = pg.image.load(os.path.join(img_folder, 'king_white.png'))
king_b = pg.image.load(os.path.join(img_folder, 'king_black.png'))
